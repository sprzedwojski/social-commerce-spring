LOAD CSV WITH HEADERS FROM "file:///home/szymon/MASTER/workspace/spring/social-commerce-spring/res/products/electronics.csv" AS c
...
CREATE (product)-[:IS_IN_CATEGORY]->(category)